...
namespace Linework.FastOutline
{
    ...
    public class FastOutline : ScriptableRendererFeature
    {
        private class FastOutlinePass : ScriptableRenderPass
        {
            ...
            private Material mask, outlineBase, outlineInstancedBase;
            ...
            public bool Setup(ref FastOutlineSettings fastOutlineSettings, ref Material maskMaterial, ref Material outlineMaterial, ref Material outlineInstancedMaterial)
            {
        ...
        private Material maskMaterial, outlineMaterial, outlineInstancedMaterial;
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            var render = fastOutlinePass.Setup(ref settings, ref maskMaterial, ref outlineMaterial, ref outlineInstancedMaterial);
        ...
        private bool CreateMaterials()
        {
            ...
            return maskMaterial != null && outlineMaterial != null && outlineInstancedMaterial != null;
        }
    }
}